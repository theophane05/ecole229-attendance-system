...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 13 juil. 2026 à 12:47
...
CREATE TABLE `coachs` (
  ...
  `matiere_enseigner` varchar(100) NOT NULL,
...
CREATE TABLE `presences` (
  ...
  `heure_arrivee` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `matiere_enseigner` varchar(100) NOT NULL,
  `id_etudiant` int(11) NOT NULL,
  `id_matiere` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
